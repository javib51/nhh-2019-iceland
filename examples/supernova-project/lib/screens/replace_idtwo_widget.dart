...
class ReplaceIDTwoWidget extends StatelessWidget {
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Container(
                                              margin: EdgeInsets.only(top: 11, right: 160),
                                              child: Text(
                                                "ID got damaged",
                                                style: TextStyle(
                                                  color: Color.fromARGB(255, 75, 74, 75),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Container(
                                            margin: EdgeInsets.only(right: 201),
                                            child: Text(
                                              "ID got lost",
                                              style: TextStyle(
                                                color: Color.fromARGB(255, 75, 74, 75),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Container(
                                            margin: EdgeInsets.only(top: 12, right: 156),
                                            child: Text(
                                              "ID got damaged",
                                              style: TextStyle(
                                                color: Color.fromARGB(255, 75, 74, 75),
