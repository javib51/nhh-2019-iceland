...
class Fingerprint3Widget extends StatelessWidget {
              ...
              child: Stack(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        constraints: BoxConstraints.expand(width: 316),
                        margin: EdgeInsets.only(top: 28),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            Container(
                              margin: EdgeInsets.only(left: 80, top: 153, right: 80),
                              child: Text(
                                "CONFIRMED!",
                                style: TextStyle(
                                  color: Color.fromARGB(255, 85, 190, 242),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: Color.fromARGB(255, 129, 183, 66),
                                          border: Border.all(
                                            color: Color.fromARGB(255, 129, 183, 66),
                                            width: 1,
                                          ),
                                        ...
                                        child: Stack(
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                Container(
                                                  constraints: BoxConstraints.expand(width: 24.97),
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    margin: EdgeInsets.only(left: 39, right: 39, bottom: 50),
                                    child: Text(
                                      "Move on with “Next”.",
                                      style: TextStyle(
