...
class DocumentAlertWidget extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Stack(
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.only(left: 118, top: 27),
                        child: Text(
                          "Heads Up!\n\n",
                          style: TextStyle(
            ...
            Container(
              margin: EdgeInsets.only(left: 72, top: 11),
              child: Text(
            ...
            Container(
              ...
              child: Container(
                ...
                child: Text(
                  "	•	Birth Certificate \n	•	Original Citizenship Certificate (only people born outside Namibia) \n	•	Original Permanent Resident Permit (only Permanent Residents) \n	•	Marriage Certificate  (only married women)\n",
                  style: TextStyle(
                    color: Color.fromARGB(255, 75, 74, 75),
                    fontSize: 14,
                    fontFamily: "Avenir Next",
