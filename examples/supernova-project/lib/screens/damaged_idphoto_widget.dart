...
class DamagedIDPhotoWidget extends StatelessWidget {
              ...
              child: Stack(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        constraints: BoxConstraints.expand(width: 265),
                        margin: EdgeInsets.only(top: 55, right: 37),
                        child: Image.asset(
                          "assets/images/idcard-final.png",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ],
