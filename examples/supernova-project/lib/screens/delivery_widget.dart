      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.only(left: 59, top: 12, right: 59),
              child: Text(
                "Where should we\nsend your new ID card to?",
                style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Container(
                          height: 78,
                          margin: EdgeInsets.only(left: 19, top: 12, right: 19),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Expanded(
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Container(
                          height: 78,
                          margin: EdgeInsets.only(left: 19, top: 86, right: 19),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              Expanded(
                                flex: 1,
                                child: Container(
                                  margin: EdgeInsets.only(left: 3, right: 260),
                                  child: Text(
                                    "Street:",
                                    style: TextStyle(
                                      color: Color.fromARGB(255, 75, 74, 75),
                          ...
                          child: Column(
                            ...
                            children: [
                              Expanded(
                                flex: 1,
                                child: Container(
                                  margin: EdgeInsets.only(left: 3, right: 278),
                                  child: Text(
                                    "City:",
                                    style: TextStyle(
                                      color: Color.fromARGB(255, 75, 74, 75),
                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          flex: 1,
                          child: Container(
                            margin: EdgeInsets.only(left: 3, right: 243),
                            child: Text(
                              "Country:",
                              style: TextStyle(
                                color: Color.fromARGB(255, 75, 74, 75),
