...
class Fingerprint1Widget extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.only(left: 56, top: 38, right: 52),
              child: Text(
            ...
            Container(
              margin: EdgeInsets.only(left: 46, top: 22, right: 38),
              child: Text(
                "There is a fingerprint scanner \nnear you.\nPlease follow the instructions for\nhow to use it by pressing “Next”. ",
                style: TextStyle(
                  color: Color.fromARGB(255, 75, 74, 75),
                  fontSize: 18,
                  fontFamily: "Avenir Next",
            ...
            Container(
              ...
              child: Container(
                margin: EdgeInsets.only(top: 22, right: 72),
                child: Image.asset(
                  "assets/images/fingerprint-scanner-germany.png",
                  fit: BoxFit.cover,
                ),
              ),
            ),
