...
class DocumentsUploadSuccessTwoWidget extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Container(
                width: 244,
                margin: EdgeInsets.only(top: 45, right: 55),
                child: Text(
                  "The following documents Uploaded Successfully",
                  style: TextStyle(
              ...
              child: Stack(
                children: [
                  Row(
                    ...
                    children: [
                      Opacity(
                        opacity: 0.18,
                        child: Container(
                          constraints: BoxConstraints.expand(width: 151),
                          child: Image.asset(
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        constraints: BoxConstraints.expand(width: 244),
                        margin: EdgeInsets.only(top: 45),
                        child: Text(
                          "1. Copy of birth certificate\n2. Police Affidavit or Old Passport",
                          style: TextStyle(
                            color: Color.fromARGB(255, 75, 74, 75),
                            fontSize: 22,
                            fontFamily: "Avenir Next",
