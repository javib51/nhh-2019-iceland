...
class Fingerprint2Widget extends StatelessWidget {
            ...
            Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Container(
                    margin: EdgeInsets.only(left: 88, top: 191),
                    child: Image.asset(
                  ...
                  child: Stack(
                    children: [
                      Row(
                        ...
                        children: [
                          Container(
                            constraints: BoxConstraints.expand(width: 207),
                            margin: EdgeInsets.only(top: 24, right: 72),
                            child: Image.asset(
                              "assets/images/fingerprint-scanner-2.png",
                              fit: BoxFit.cover,
                            ),
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.only(left: 139, top: 47),
                            child: Image.asset(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    width: 131,
                                    height: 46,
                                    margin: EdgeInsets.only(right: 15, bottom: 13),
                                    decoration: BoxDecoration(
                                      color: Color.fromARGB(255, 151, 151, 151),
                                      border: Border.all(
                                        color: Color.fromARGB(255, 151, 151, 151),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(left: 86, top: 19, right: 86),
                        child: Text(
                          "Right Thumb\nflat",
                          style: TextStyle(
                            color: Color.fromARGB(255, 85, 190, 242),
                      ...
                      Container(
                        margin: EdgeInsets.only(left: 25, top: 1, right: 25),
                        child: Text(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              margin: EdgeInsets.only(left: 37, right: 37, bottom: 54),
                              child: Text(
