        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Container(
                margin: EdgeInsets.only(top: 59, right: 38),
                child: Text(
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Container(
                          height: 24,
                          margin: EdgeInsets.only(left: 305, top: 76, right: 31),
                          decoration: BoxDecoration(
                            boxShadow: [
                              BoxShadow(
                                color: Color.fromARGB(128, 0, 0, 0),
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              margin: EdgeInsets.only(left: 3, right: 209),
                              child: Text(
                                "Eye Colour*:",
                                style: TextStyle(
                                  color: Color.fromARGB(255, 75, 74, 75),
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Container(
                          height: 24,
                          margin: EdgeInsets.only(left: 305, top: 56, right: 31),
                          decoration: BoxDecoration(
                            boxShadow: [
                              BoxShadow(
                                color: Color.fromARGB(128, 0, 0, 0),
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              margin: EdgeInsets.only(left: 3, right: 184),
                              child: Text(
                                "Marital Status*:",
                                style: TextStyle(
                                  color: Color.fromARGB(255, 75, 74, 75),
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Container(
                          height: 24,
                          margin: EdgeInsets.only(left: 303, top: 54, right: 33),
                          decoration: BoxDecoration(
                            boxShadow: [
                              BoxShadow(
                                color: Color.fromARGB(128, 0, 0, 0),
