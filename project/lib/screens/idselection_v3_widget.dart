...
class IDSelectionV3Widget extends StatelessWidget {
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Container(
                                                margin: EdgeInsets.only(top: 11, right: 137),
                                                child: Text(
                                                  "Apply for my first ID",
                                                  style: TextStyle(
                                                    color: Color.fromARGB(255, 75, 74, 75),
                                                    fontSize: 14,
                                                    fontFamily: "Avenir Next",
                                            ...
                                            Container(
                                              alignment: Alignment.topRight,
                                              child: Container(
                                                margin: EdgeInsets.only(top: 20, right: 89),
                                                child: Text(
                                                  "Replace damaged or lost ID",
                                                  style: TextStyle(
                                                    color: Color.fromARGB(255, 75, 74, 75),
                                                    fontSize: 14,
                                                    fontFamily: "Avenir Next",
