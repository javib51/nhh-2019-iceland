...
class DamagedIDPhotoTwoWidget extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: Container(
                ...
                child: Text(
                  "Please take a photo of your damaged ID.",
                  style: TextStyle(
              ...
              child: Stack(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        constraints: BoxConstraints.expand(width: 266),
                        margin: EdgeInsets.only(top: 33),
                        child: Image.asset(
                          "assets/images/table-camerapic.png",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ],
